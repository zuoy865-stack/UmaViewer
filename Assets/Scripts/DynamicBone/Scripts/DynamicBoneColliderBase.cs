...
public class DynamicBoneColliderBase : MonoBehaviour
{
    ...
    public virtual bool Collide(ref Vector3 particlePosition, float particleRadius, Vector3 particlePrevPosition)
    {
        return Collide(ref particlePosition, particleRadius);
    }
