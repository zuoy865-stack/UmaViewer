...
public class UmaContainerCharacter : UmaContainer
{
    ...
    public void LoadPhysics()
    {
        ...
        var duplicateBoneNames = new HashSet<string>();
        ...
        {
            Debug.LogWarning(
                $"[UmaContainerCharacter] Duplicate bone names detected before physics bind: {duplicateBoneNames.Count}\n" +
    ...
    public void ConfigureLivePhysics()
    {
        ...
        foreach (CySpringDataContainer cySpring in cySpringDataContainers)
        {
            if (cySpring == null || cySpring.DynamicBones == null) continue;

            foreach (DynamicBone dynamic in cySpring.DynamicBones)
            {
                if (dynamic == null) continue;

                dynamic.m_UpdateMode = DynamicBone.UpdateMode.Default;
                dynamic.m_UpdateRate = 60f;
